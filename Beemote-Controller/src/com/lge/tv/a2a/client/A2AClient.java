...
public abstract class A2AClient {
	...
	public enum A2ACmdError {
		A2ACmdErrorOK,
		A2ACmdErrorBadRequest,
		A2ACmdErrorUnauthorized,
		A2ACmdErrorNotFound,
		A2ACmdErrorNotAcceptable,
		A2ACmdErrorRequestTimeout,
		A2ACmdErrorConflict,
		A2ACmdErrorInternalServerError,
		A2ACmdErrorServiceUnavailable,
		A2ACmdErrorNoCurrentTV,
		A2ACmdErrorUnknown,
	}
	 ...
	 * @param passcode the codes TV show.
	 * @return command result
	 * @throws IOException in case of a problem or the connection was aborted
	 */
	...
	abstract public QueryResultAppID queryAppId(String appName) throws IOException;

	abstract public QueryResultStatus queryAppStatus(long appId) throws IOException;

	/**
	 * Send a char array message to the TV.
	 * @param appId target TV application ID.
	 * @param messageType the message type want to send to TV.
	 * @param message the message want to send to TV.
	 * @return command result
	 * @throws IOException in case of a problem or the connection was aborted
	 */
	abstract public A2ACmdError sendMessage(long appId, int messageType, String message) throws IOException;

	/**
	 * Execution an application.
	 * @param appId TV Application ID.
	 * @return command result
	 * @throws IOException in case of a problem or the connection was aborted
	 */
	...
	abstract public A2ACmdError sendRemoteKey(int keyValue) throws IOException;
}
